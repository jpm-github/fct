...
?>
 ...
 <?php
	if($opcion==1){
		?>
					<input type="text" name="nombre" placeholder="Nombre empresa" required class="input_recuadro">	
					</br></br>
					<input type="submit" name="btn_regis" value="Seleccionar empresa" class="btn_recuadro"> 
		<?php	
	}elseif($opcion==2){
		?>
					<input type="text" name="nombre" placeholder="Nombre alumno" required class="input_recuadro">	
					</br></br>
